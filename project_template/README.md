...
2. Copy the contents of `opencode/` into the root of your project.
...
**Tier 1 - Fully Supported** -- Tested by gald3r maintainers on every release. Bugs filed against this tier block release.
