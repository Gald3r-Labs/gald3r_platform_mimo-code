# Agent Skills cross-client standard — gald3r Deploy Scaffold

**Config folder**: `.agents/`

This directory is the gald3r deploy scaffold for **Agent Skills cross-client standard**. It is registered in
